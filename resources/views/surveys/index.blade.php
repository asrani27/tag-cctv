...
@section('page_title', 'Data Survey CCTV & WiFi')

@section('content')
<div class="space-y-5">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-xl font-bold text-slate-900">Daftar Data Survey</h1>
            <p class="text-xs text-slate-500 mt-0.5">Kelola titik lokasi survey kamera CCTV dan akses point WiFi Kota Banjarmasin</p>
        </div>
    ...
    <x-card padding="p-0">
        @if ($surveys->isEmpty())
            <div class="text-center py-12 px-4">
                ...
                @if ($currentSearch || $currentKecamatan || $currentKoneksi)
